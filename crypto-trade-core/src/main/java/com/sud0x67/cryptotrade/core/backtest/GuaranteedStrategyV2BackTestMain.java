...
import com.sud0x67.cryptotrade.core.strategy.GuaranteedStrategy;
import java.util.List;

public class GuaranteedStrategyV2BackTestMain {

  public static void main(String[] args) {

    // TODO ATTENTION GuaranteedStrategyV2 will sleep for 1 second when executing please check it
    // when back test.
    String path =
        GuaranteedStrategyV2BackTestMain.class.getResource("/data/spot/btc/2023/1h").getPath();
    ...
    GuaranteedStrategy guaranteedStrategyV2 = new GuaranteedStrategy(backTestEnv);
    while (!backTestEnv.stop()) {
      guaranteedStrategyV2.execute(OrderSymbol.BTCFDUSD);
      backTestEnv.update();
    }
