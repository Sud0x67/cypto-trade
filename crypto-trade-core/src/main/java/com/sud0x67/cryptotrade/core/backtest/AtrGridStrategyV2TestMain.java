...
import com.sud0x67.cryptotrade.core.strategy.AtrGridStrategy;
import java.util.List;

public class AtrGridStrategyV2TestMain {
  public static void main(String[] args) {
    ...
    AtrGridStrategy atrGridStrategyV2 = new AtrGridStrategy(backTestEnv);
    atrGridStrategyV2.init();
    while (!backTestEnv.stop()) {
      atrGridStrategyV2.execute();
      backTestEnv.update();
    }
